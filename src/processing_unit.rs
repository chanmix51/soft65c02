...
fn resolve_opcode(address: usize, opcode: u8, memory: &Memory) -> CPUInstruction {
    ...
    match opcode {
        ...
        0x11    => instr::new(address, opcode, "ORA", AM::ZeroPageIndirectYIndexed(op1), mc::ora),
        ...
        0x21    => instr::new(address, opcode, "AND", AM::ZeroPageXIndexedIndirect(op1), mc::and),
        ...
        0x31    => instr::new(address, opcode, "AND", AM::ZeroPageIndirectYIndexed(op1), mc::and),
        ...
        0x41    => instr::new(address, opcode, "EOR", AM::ZeroPageXIndexedIndirect(op1), mc::eor),
        ...
        0x51    => instr::new(address, opcode, "EOR", AM::ZeroPageIndirectYIndexed(op1), mc::eor),
        ...
        0x61    => instr::new(address, opcode, "ADC", AM::ZeroPageXIndexedIndirect(op1), mc::adc),
        ...
        0x71    => instr::new(address, opcode, "ADC", AM::ZeroPageIndirectYIndexed(op1), mc::adc),
        ...
        0x7c    => instr::new(address, opcode, "JMP", AM::AbsoluteXIndexedIndirect(op2), mc::jmp),
        ...
        0x81    => instr::new(address, opcode, "STA", AM::ZeroPageXIndexedIndirect(op1), mc::sta),
        ...
        0x91    => instr::new(address, opcode, "STA", AM::ZeroPageIndirectYIndexed(op1), mc::sta),
        ...
        0xa1    => instr::new(address, opcode, "LDA", AM::ZeroPageXIndexedIndirect(op1), mc::lda),
        ...
        0xb1    => instr::new(address, opcode, "LDA", AM::ZeroPageIndirectYIndexed(op1), mc::lda),
        ...
        0xc1    => instr::new(address, opcode, "CMP", AM::ZeroPageXIndexedIndirect(op1), mc::cmp),
        ...
        0xd1    => instr::new(address, opcode, "CMP", AM::ZeroPageIndirectYIndexed(op1), mc::cmp),
        ...
        0xe1    => instr::new(address, opcode, "SBC", AM::ZeroPageXIndexedIndirect(op1), mc::sbc),
        ...
        0xf1    => instr::new(address, opcode, "SBC", AM::ZeroPageIndirectYIndexed(op1), mc::sbc),
