...
pub fn txa(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_txa() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "TXA", AddressingMode::Implied, txa);
