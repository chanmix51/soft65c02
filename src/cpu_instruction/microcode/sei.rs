...
pub fn sei(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_sei() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "SEI", AddressingMode::Implied, sei);
