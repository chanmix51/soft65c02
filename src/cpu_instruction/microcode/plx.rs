...
pub fn plx(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    fn test_plx() {
        ...
        assert_eq!(format!("#0x1000: (08)          PLX                      [X=0x10][SP=0xff][S=nv-Bdizc]"), format!("{}", log_line));
    }
