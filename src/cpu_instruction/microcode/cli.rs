...
pub fn cli(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_cli() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "CLI", AddressingMode::Implied, cli);
