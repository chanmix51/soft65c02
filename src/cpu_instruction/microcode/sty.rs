...
pub fn sty(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_sty() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "STY", AddressingMode::ZeroPage([0x0a]), sty);
