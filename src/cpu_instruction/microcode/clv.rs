...
pub fn clv(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_clv() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "CLV", AddressingMode::Implied, clv);
