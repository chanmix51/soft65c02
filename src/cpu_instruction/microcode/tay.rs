...
pub fn tay(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_tay() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "TAY", AddressingMode::Implied, tay);
