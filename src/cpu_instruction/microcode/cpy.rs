...
pub fn cpy(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_cpy_be() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "CPY", AddressingMode::Immediate([0x0a]), cpy);
