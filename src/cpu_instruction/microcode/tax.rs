...
pub fn tax(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_tax() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "TAX", AddressingMode::Implied, tax);
