...
pub fn tya(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_tya() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "TYA", AddressingMode::Implied, tya);
