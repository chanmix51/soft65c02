...
pub fn sed(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_sed() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "SED", AddressingMode::Implied, sed);
