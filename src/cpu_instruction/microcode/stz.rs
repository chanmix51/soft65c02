...
pub fn stz(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_stz() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "STZ", AddressingMode::Absolute([0x00, 0x10]), stz);
