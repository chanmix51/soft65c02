...
pub fn cmp(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_cmp_be() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "CMP", AddressingMode::Immediate([0x0a]), cmp);
