...
pub fn phy(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_phy() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "PHY", AddressingMode::Implied, phy);
