...
pub fn iny(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_iny() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "INY", AddressingMode::Implied, iny);
