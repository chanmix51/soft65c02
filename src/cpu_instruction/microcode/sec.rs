...
pub fn sec(memory: &mut Memory, registers: &mut Registers, cpu_instruction: &CPUInstruction) -> Result<LogLine> {
...
mod tests {
    ...
    #[test]
    fn test_sec() {
        let cpu_instruction = CPUInstruction::new(0x1000, 0xca, "SEC", AddressingMode::Implied, sec);
